...
Controller.prototype.get = function (request, h) {
    ...
    var where = { wx_user_id: request.params.wx_user_id };
...
Controller.prototype.getSessionKey2 = function (request, h) {
    return this.service.getSessionKey2(request.query.jscode).then(function (result) {
        return h.success(result);
    }).catch(function (err) {
        return h.error(Boom.badRequest(err.message, err));
    });
...
Controller.prototype.DecryptMimiAppUser2 = function (request, h) {
    var body = request.payload;
    var session_key = body.session_key;
    var encrypted_data = body.encrypted_data;
    var iv = body.iv;
    return this.service.DecryptMimiAppUser2(session_key, encrypted_data, iv).then(function (result) {
        return h.success(result);
    }).catch(function (err) {
        return h.error(Boom.badRequest(err.message, err));
    });
